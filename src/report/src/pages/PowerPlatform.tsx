...
export default function PowerPlatform() {
    return (
        <>
            <PageHeader>
                <PageHeaderHeading>Power Platform</PageHeaderHeading>
            </PageHeader>
            <Card>
                <CardHeader>
                    <CardTitle className="mb-3">Assessment results</CardTitle>
                    <CardDescription>
                        The results presented below are based on Power Platform security principles.
                    </CardDescription>
                </CardHeader>
                <CardContent className="gap-4 px-4 pb-4 pt-1">
                    <DataTable columns={columns} data={reportData.Tests} pillar="PowerPlatform" />
                </CardContent>
            </Card>
        </>
    )
