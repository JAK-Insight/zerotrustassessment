...
**Remediation action**
1. Sign in to the [Microsoft Purview portal](httpsgate to [DLP Policies](https://purview.microsoft.com/datalossprevention Enable alerting and/or incident reporting:
